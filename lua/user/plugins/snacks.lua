return {
  {
    ...
    opts = {
      ...
      picker = {
        ...
        sources = {
          ...
          files = { layout = { border = "none", preset = "dropdown", layout = { width = 0.90, height = 0.92 } } }, -- files = { layout = { layout = { width = 0.90, height = 0.90 } } },
    ...
    keys = {
      ...
      { "<leader>sk", function() Snacks.picker.keymaps() end,                                            desc = "Highlights", },
